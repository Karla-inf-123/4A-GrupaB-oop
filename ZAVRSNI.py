...
class PlanerkoApp(tk.Tk):
    ...
    def _kreiraj_ui(self):
        ...
        tk.Button(main_frame, text='Označi kao odrađeno', command=self.oznaci_odradeno, bg='#4CAF50', fg='white').grid(row=11,column=0,columnspan=2,pady=2, sticky='ew')
        tk.Button(main_frame, text='Izbriši odabrano', command=self.brisi_odabrano, bg='#D85D9C', fg='white').grid(row=12,column=0,columnspan=2,pady=2, sticky='ew')
        tk.Button(main_frame, text='Tjedni sažetak', command=self.tjedni_izvjestaj, bg='#D85D9C', fg='white').grid(row=13,column=0,columnspan=2,pady=2, sticky='ew')
        tk.Button(main_frame, text='Mjesečni izvještaj', command=self.mjesecni_izvjestaj, bg='#D85D9C', fg='white').grid(row=14,column=0,columnspan=2,pady=2, sticky='ew')
